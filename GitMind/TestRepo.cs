namespace GitMind
{
	public static class TestRepo
	{
		...
		public static readonly string Path = @"d:\My Work\TestGit";
		...
		public static readonly string Path6 = @"C:\Work Files\AcmAcs2";
		...
		public static readonly string SystemServer = "branches/Bespin/SystemServer";

		public static readonly string Path3 = @"d:\My Work\TestGit3";
		public static readonly string Refactor = "branches/Refactor";
